...
# -----------------------------
# PDF CONVERSION HELPERS (LibreOffice for Linux)
# -----------------------------
def convert_docx_to_pdf(docx_path, output_dir):
    ...
    if result.returncode != 0:
        error_msg = f"LibreOffice error (code {result.returncode}): {result.stderr}"
        print(error_msg)
        raise Exception(error_msg)
    
    return True

def convert_batch(docx_paths, output_dir, workers=1):
    """Sequential conversion - stable for EC2"""
    total = len(docx_paths)
    for idx, (docx_path, _) in enumerate(docx_paths, 1):
        print(f"Converting {idx}/{total}: {os.path.basename(docx_path)}")
...
def generate_borrower_pdf(excel_path, borrower_tpl, output_dir):
    ...
    for _, row in df.iterrows():
        ...
        doc.save(docx_path)
        docx_paths.append((docx_path, pdf_path))
    
    convert_batch(docx_paths, pdf_dir)
...
# -----------------------------
def generate_Letter_Head_Registration_borrower(excel_path, template_path, output_dir):
    df = pd.read_excel(excel_path)
...
# -----------------------------
def generate_Letter_Head_Registration_guarantor(excel_path, template_path, output_dir):
    df = pd.read_excel(excel_path)
...
# DEMAND NOTICE PSF
# =========================================================
def generate_demand_notice_psf(excel_path, template_path, output_dir):
    df = pd.read_excel(excel_path)
    ...
    for _, row in df.iterrows():
        ...
        context = {
            ...
            "borrower_address": format_address(safe(row.get("borrower_address"))),
...
# DEMAND NOTICE SMS
# =========================================================
def generate_demand_notice_sms(excel_path, template_path, output_dir):
    df = pd.read_excel(excel_path)
...
# DUE NOTICE PSF
# =========================================================
def generate_due_notice_psf(excel_path, template_path, output_dir):
    df = pd.read_excel(excel_path)
...
# DUE NOTICE SMS
# =========================================================
def generate_due_notice_sms(excel_path, template_path, output_dir):
    df = pd.read_excel(excel_path)
...
# DUE NOTICE SMF
# =========================================================
def generate_due_notice_smf(excel_path, template_path, output_dir):
    df = pd.read_excel(excel_path)
...
# PRE SALE PSF
# =========================================================
def generate_pre_sale_psf(excel_path, template_path, output_dir):
    df = pd.read_excel(excel_path)
...
# PRE SALE SMS
# =========================================================
def generate_pre_sale_sms(excel_path, template_path, output_dir):
    df = pd.read_excel(excel_path)
    ...
    for _, row in df.iterrows():
        context = {
            "notice_date": format_date(row.get("notice_date")),
            "borrower_name": safe(row.get("borrower_name")),
            "borrower_adderss": format_address(safe(row.get("borrower_address"))),
            "borrower_mobile": format_mobile(row.get("borrower_mobile")),
            "loan_account": safe(row.get("loan_account")),
            "vehicle_no": safe(row.get("vehicle_no")),
        }
...
# PRE SALE SMF
# =========================================================
def generate_pre_sale_smf(excel_path, template_path, output_dir):
    df = pd.read_excel(excel_path)
...
# =========================================================
def generate_police_intimation_psf(excel_path, template_path, output_dir):
    df = pd.read_excel(excel_path)
...
# =========================================================
def generate_police_intimation_sms(excel_path, template_path, output_dir):
    df = pd.read_excel(excel_path)
